...
import { prefetchDeckData } from '../../../utils/prefetch'; // Import the prefetch utility
...
export default function Page() {
    ...
    const DeckLink = ({ deck }: { deck: Deck }) => (
        ...
        >
            ...
            <p className='text-sm'>{deck.deck_description}</p>
        </Link>
    );
        ...
        <>
            ...
            <div className='flex gap-6 w-full flex-col-reverse'>
                {decks.length > 0 ? (
                    ...
                    <p>No decks available. Start by creating a new one!</p>
                )}
            </div>
        </>
    );
